...
import com.xyz.desensitize.util.entry.CustomUserCollection;
import com.xyz.desensitize.util.entry.CustomUserEntryBaseType;
import com.xyz.desensitize.util.entry.CustomUserEntryObject;
import com.xyz.desensitize.util.entry.CustomUserGroup;
...
public class CustomSensitiveEntryTest {
    ...
    public void sensitiveEntryBaseTypeTest() {
        ...
        CustomUserEntryBaseType sensitive = DesensitizeUtil.desensitizeObj(userEntryBaseType);
    ...
    public void sensitiveEntryObjectTest() {
        ...
        CustomUserEntryObject sensitiveUserEntryObject = DesensitizeUtil.desensitizeObj(userEntryObject);
