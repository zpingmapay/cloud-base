...
public class GeoUtilsTest {
    ...
    public void testDistance() {
        ...
        Assert.isTrue(Double.compare(distance, p2.distance(p1)) == 0, "distance not correct");
    ...
    public void testIsClockwise() {
        ...
        Point p0 = new Point(121.4756906033, 31.2303806967);
        Point p1 = new Point(121.4738023281, 31.2302063883);
        Point p2 = new Point(121.4746928215, 31.2298394224);
        Assert.isTrue(!GeoUtils.isClockwise(p0, p1, p2), "should not be clockwise");
